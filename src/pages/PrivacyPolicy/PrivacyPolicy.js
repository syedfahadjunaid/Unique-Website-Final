  ...
  return (
    <div className="flex flex-col w-full items-center mt-[2rem] mb-[3rem]">
      <div className="w-11/12 ">
        <h2 className="text text-[4rem] mobile:text-[1.5rem] tablet:text-[2.5rem]">
          Privacy Policy
        </h2>
      </div>
      <div className="w-11/12 mt-[3rem] bg-[#353535] p-[2rem] mobile:mt-[1rem]">
        <div className="w-full mt-[2.5rem] flex flex-col justify-start gap-4 items-center mobile:mt-[0rem] tablet:mt-[2rem]">
          <h6 className="text-[2rem] text-[#fff] font-semibold text-start w-full">
            Privacy policy
          </h6>
